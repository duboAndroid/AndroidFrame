...
public class AbFlipperLayout extends ViewGroup {
	 ...
	 */
	public AbFlipperLayout(Context context) {
		super(context);
	 ...
	 */
	public AbFlipperLayout(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * @param attrs the attrs
	 */
	public AbFlipperLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
